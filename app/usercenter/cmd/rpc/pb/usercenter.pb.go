...
type RegisterReq struct {
	...
	MsgCode  string `protobuf:"bytes,6,opt,name=msgCode,proto3" json:"msgCode"`
}
...
type GetCaptchaResp struct {
	...
	ImageBase64 string `protobuf:"bytes,1,opt,name=imageBase64,proto3" json:"imageBase64"`
	ThumbBase64 string `protobuf:"bytes,2,opt,name=thumbBase64,proto3" json:"thumbBase64"`
	CaptchaKey  string `protobuf:"bytes,3,opt,name=captchaKey,proto3" json:"captchaKey"`
}
...
type VerfyCaptchaReq struct {
	...
	Dots       []int64 `protobuf:"varint,1,rep,packed,name=dots,proto3" json:"dots"`
	CaptchaKey string  `protobuf:"bytes,2,opt,name=captchaKey,proto3" json:"captchaKey"`
}
...
var file_usercenter_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x92, 0x04, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x63,
	...
	0x62, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x27, 0x0a, 0x06, 0x6c,
	...
	0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x12, 0x33, 0x0a, 0x0a, 0x47,
	...
	0x12, 0x39, 0x0a, 0x0c, 0x56, 0x65, 0x72, 0x66, 0x79, 0x43, 0x61, 0x70, 0x74, 0x63, 0x68, 0x61,
	0x12, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x56, 0x65, 0x72, 0x66, 0x79, 0x43, 0x61, 0x70, 0x74, 0x63,
	0x68, 0x61, 0x52, 0x65, 0x71, 0x1a, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x56, 0x65, 0x72, 0x66, 0x79,
	0x43, 0x61, 0x70, 0x74, 0x63, 0x68, 0x61, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06, 0x5a, 0x04, 0x2e,
...
var file_usercenter_proto_depIdxs = []int32{
	...
	7,  // 13: pb.usercenter.logout:output_type -> pb.LogoutResp
	3,  // 14: pb.usercenter.register:output_type -> pb.RegisterResp
	9,  // 15: pb.usercenter.getUserInfo:output_type -> pb.GetUserInfoResp
	11, // 16: pb.usercenter.getUserAuthByAuthKey:output_type -> pb.GetUserAuthByAuthKeyResp
	13, // 17: pb.usercenter.getUserAuthByUserId:output_type -> pb.GetUserAuthyUserIdResp
	15, // 18: pb.usercenter.generateToken:output_type -> pb.GenerateTokenResp
	17, // 19: pb.usercenter.GetCaptcha:output_type -> pb.GetCaptchaResp
	19, // 20: pb.usercenter.VerfyCaptcha:output_type -> pb.VerfyCaptchaResp
